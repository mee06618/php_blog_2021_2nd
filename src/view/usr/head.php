...
<body>
    <div class="site-wrap min-h-screen flex flex-col pt-10 ">
        <header class="top-bar hidden md:block fixed top-0 inset-x-0 text-white h-10">
            <div class="container mx-auto h-full flex ml-20 mr-20">
                <a href="/" class="top-bar__logo px-5 flex items-center">
                    <span><i class="fas fa-meteor"></i></span>
                    <span class="ml-2 font-bold hidden sm:inline">재연의 개발방</span>
                </a>
        ...
        <main class="flex-grow">
            <section class="section-title mt-5 text-2xl font-bold">
                <h1 class="container mx-auto  mr-20 ml-20">
                    <div class="con-pad">
